...
class CliensList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ClientList:[],
  ...
  render(){
    ...
    return(
      <div>
        <Row style={{display:'flex',borderBottom:'1px dashed #B8B8B8',marginLeft:'13px',marginRight:'18px'}}>    
          <Col  xs={{ span: 5, offset: 0 }} sm={{ span: 5, offset: 0 }} md={{ span: 5, offset: 0 }} lg={{ span: 6, offset: 0 }} xl={{ span: 5, offset: 0 }}>
            <h3 className = "text" style={{marginTop:'24px',marginBottom:'11px'}} > Customer Lists</h3> 
          </Col>
          <Col  xs={{ span: 5, offset: 20 }} sm={{ span: 5, offset: 0 }} md={{ span: 5, offset: 0 }} lg={{ span: 6, offset: 0 }} xl={{ span: 1, offset: 15 }}>
            <Link to={`/New_Clients`}><Button  shape="omitted" type="primary" style={{background:'#8854D0',borderRadius:'28px',marginBottom:'10px',marginTop:'22px',marginRight:'10px'}} >New Customer</Button></Link>
          </Col>
          <Col  xs={{ span: 5, offset: 20 }} sm={{ span: 5, offset: 0 }} md={{ span: 5, offset: 0 }} lg={{ span: 6, offset: 0 }} xl={{ span: 1, offset: 1 }}>
            <Link to={`/`}><Button  shape="omitted"  style={{color : '#505050',marginBottom:'10px',borderRadius:'28px',marginLeft:'30px',marginTop:'22px',marginLeft:'32px'}} >Import</Button></Link>
          </Col>
...
*/
export default Form.create()(
    connect(mapStateToProps)(CliensList),
  );